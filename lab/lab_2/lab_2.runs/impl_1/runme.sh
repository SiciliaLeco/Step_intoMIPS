...
HD_PWD='C:/Users/liqilin/.Xilinx/school/lab_2/lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tops.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tops.tcl -notrace
