...
HD_PWD='C:/Users/liqilin/.Xilinx/school/lab_2/lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tops.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tops.tcl
